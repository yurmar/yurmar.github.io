 ...
 * Build: http://modernizr.com/download/#-backgroundsize-borderimage-borderradius-boxshadow-flexbox-flexboxlegacy-multiplebgs-opacity-rgba-textshadow-cssanimations-csscolumns-generatedcontent-cssgradients-cssreflections-csstransforms-csstransforms3d-csstransitions-applicationcache-draganddrop-hashchange-history-audio-video-indexeddb-input-inputtypes-localstorage-postmessage-sessionstorage-websockets-websqldatabase-webworkers-shiv-mq-cssclasses-teststyles-testprop-testallprops-hasevent-prefixes-domprefixes-load
 */
...
$(function(){$("#my-menu").mmenu({extensions:["widescreen","effect-menu-slide","pagedim-black"],navbar:{title:"БК ИРКУТ"},offCanvas:{position:"right"}}),$(".news-item-content p").equalHeights(),$(".news-item h3").equalHeights(),$(".player-news-item h2").equalHeights(),$(".theam-players").owlCarousel({loop:!0,items:1,dots:!1,smartspeed:700,nav:!0,navText:['<i class="fa fa-angle-double-left"></i>','<i class="fa fa-angle-double-right"></i>']}),$(".partners").owlCarousel({loop:!0,dots:!1,smartspeed:700,nav:!0,navText:['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],responsiveClass:!0,responsive:{0:{items:1},480:{items:2},640:{items:3},800:{items:4}}}),$("#my-menu-header").mmenu({extensions:["widescreen","effect-menu-slide","pagedim-black"],navbar:{title:"БК ИРКУТ"},offCanvas:{position:"left"}}),$(".pic-name span").each(function(){var e=$(this);e.html(e.html().replace(/^(\S+)/,"<b>$1</b>"))}),$(".player-desc h1").each(function(){var e=$(this);e.html(e.html().replace(/^(\S+)/,"<b>$1</b>"))})}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")});