...
$(function(){$("#my-menu").mmenu({extensions:["widescreen","effect-menu-slide","pagedim-black"],navbar:{title:'<img src="img/logo.png" alt="Тонусный зал Lis">'},offCanvas:{position:"right"}}),$("#my-menu").data("mmenu").bind("opened",function(){$(".hamburger").addClass("is-active")}).bind("closed",function(){$(".hamburger").removeClass("is-active")}),$("section h1").each(function(){var e=$(this);e.html(e.html().replace(/^(\S+)/,"<span>$1</span>"))}),$(".popup_content").magnificPopup({type:"inline",midClick:!0}),$(".button_item").each(function(e){$(this).find(".popup_content").attr("href","#work_"+e),$(this).find(".podrt_descr").attr("id","work_"+e)}),$(".reviews").owlCarousel({loop:!0,items:1,smartSpeed:700,nav:!1}),$(".top").click(function(){$("html, body").stop().animate({scrollTop:0},"slow","swing")}),$(window).scroll(function(){$(this).scrollTop()>$(window).height()?$(".top").addClass("active"):$(".top").removeClass("active")}),$("#my-menu ul a").mPageScroll2id()}),$(window).on("load",function(){$(".preloader").delay(1e3).fadeOut("slow")}),$(document).ready(function(){$(".animation_2").animated("fadeInLeft","fadeOutDown")});